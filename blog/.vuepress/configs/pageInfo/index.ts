...
export const headConfig: HeadConfig[] = [
  ...
  [ 'meta', { name: 'baidu-site-verification', content: 'code-Hg9Z7syVP3' } ],
  ...
  [ "meta", { name: "twitter:image", content: "https://blog.qbb.sh/images/logo.png" } ],
  ...
  [ "meta", { name: "og:url", content: "https://blog.qbb.sh/" } ],
  [ "meta", { name: "og:type", content: "article" } ],
  [ "meta", { name: "og:locale", content: "zh-CN" } ],
  [ "meta", { name: "og:image", content: "https://blog.qbb.sh/images/logo.png" } ],
